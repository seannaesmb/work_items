...
wb = openpyxl.load_workbook(r"C:\\projects\\sbrown\\Python\\db_file_exports\\20260922\\master_output\\master_workbook_with_columns_with_comments.xlsx")
master_ws = wb["jira_compatible_work_packages_n"]
control_ws = wb["relations_non_ascii"]
...
# Save workbook
wb.save(r"C:\\projects\\sbrown\\Python\\db_file_exports\\20260922\\master_output\\master_workbook_with_columns_with_relations_with_comments.xlsx")
print("✅ Master sheet updated and saved as 'Master_Workbook_with_relations.xlsx'")
now = datetime.now()
formatted_date = now.strftime("%Y-%m-%d-%H-%M")
print(f"Formatted Date: {formatted_date}")